...
export default function UserProfile(props) {
  ...
  useEffect(() => {
    if (postData) {
      ...
      setImagePath(postData?.image ? postData?.image : "/images/1.jpg");
  ...
  return (
    <div className="card1 mt-4  ">
      ...
      <div className="cardBody d-flex flex-column flex-md-row p-3">
        <div className="avatar-setting col-12 col-md-3 mb-3 mb-md-0">
        ...
        <div className="general-setting fake-user col-12 col-md-9">
          <div className=" userSettingBox">
            <form>
              <div className="row ">
