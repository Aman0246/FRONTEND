...
import { appSetting, coinSetting, fakeDataSetting, firebaseNotificationSetting, mediaModerationSetting, resendApiSetting, shortsEffectSetting, waterMarkSetting, zegoSetting } from "@/extra/infoContent";
...
const AppSetting = () => {
  ...
  const [zegoServerSecret, setZegoServerSecret] = useState<string>("");
  ...
  useEffect(() => {
    ...
    setAndroidAppVersion(settingData?.androidAppVersion);
    setIosAppVersion(settingData?.iosAppVersion);
    setAndroidAppLink(settingData?.androidAppLink);
    setIosAppLink(settingData?.iosAppLink);

    setInitialValues({
      privacyPolicyLink: settingData?.privacyPolicyLink,
      termsOfUsePolicyLink: settingData?.termsOfUsePolicyLink,
      zegoAppId: settingData?.zegoAppId,
      zegoAppSignIn: settingData?.zegoAppSignIn,
      coinCharge: settingData?.coinCharge,
      ...
      videoBanned: settingData?.videoBanned?.join(","),
      postBanned: settingData?.postBanned?.join(","),
      ...
      loginBonus: settingData?.loginBonus,
      pkEndTime: settingData?.pkEndTime,
      openAIKey: settingData?.openAIKey,
      zegoServerSecret: settingData?.zegoServerSecret,
      androidAppVersion: settingData?.androidAppVersion,
      iosAppVersion: settingData?.iosAppVersion,
      ...
      <div className="payment-setting card1 p-0">
        <div className="cardHeader">
          <div className=" align-items-center d-flex flex-wrap justify-content-between p-3">
            <div>
              <p className="m-0 fs-5 fw-medium">General Setting</p>
            </div>
            <Button
              btnName={"Submit"}
              type={"button"}
        ...
        <div className="payment-setting-box p-3">
          <div className="row">
                ...
                <div className="withdrawal-box payment-box mt-4">
                  <div className="row">
                    ...
                    >
                      ...
                      <InfoTooltip
                        title="Image and Video Moderation"
                        content={mediaModerationSetting}
                      />
                    </h6>
                ...
                <div className="withdrawal-box payment-box mt-4">
                  ...
                  >
                    ...
                    <InfoTooltip
                      ...
                      content={firebaseNotificationSetting}
                    />
                  </h6>
                  <div className="row">
                    <div className="row">
            ...
            <div className="col-6">
              <div className="mb-4">
                <div className="withdrawal-box payment-box">
                  <h6 className="d-flex justify-content-between align-items-center">Fake Data Setting
                    <InfoTooltip title="Shorts Effect Setting" content={fakeDataSetting} />
                ...
                <div className="mb-4 mt-4">
                  <div className="withdrawal-box">
                    <h6 className="d-flex justify-content-between align-items-center">
                      Water Mark Setting
                      <InfoTooltip
                        title="Water Mark Setting"
                        content={waterMarkSetting}
                      />
                    </h6>
                    <div className="row">
                      ...
                      <div className="d-flex justify-content-center mt-4 ">
                        <div className="col-6">
                          <label
                            className={`radio-label ${selectedOption === "inactive"
                              ? "active-radio"
                              : ""
                              }`}
                          >
                ...
                <div className="withdrawal-box payment-box mt-4">
                  <h6 className="d-flex justify-content-between align-items-center">Shorts Effect Setting
                    <InfoTooltip title="Shorts Effect Setting" content={shortsEffectSetting} />
